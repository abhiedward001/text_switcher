    ...
    return (
        ...
        <>
            <div className="container my-5" style={{ color: props.mode === 'dark' ? 'white' : 'black' }}>
                ...
                <button disabled={Text.length === 0} className="btn btn-primary mx-2" onClick={updateTextupper}>Convert to Uppercase</button>
                <button disabled={Text.length === 0} className="btn btn-primary mx-2" onClick={updateTextlower}>Convert to Lowercase</button>
            </div>
